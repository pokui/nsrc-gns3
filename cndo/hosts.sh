...
cat <<EOS
192.168.122.$((10*campus))		eth1.srv1.campus${campus}.ws.nsrc.org srv1.campus${campus}.ws.nsrc.org librenms.campus${campus}.ws.nsrc.org srv1-campus${campus}
EOS
for i in $(seq 1 6); do
cat <<EOS
...
2001:DB8:0:0::250	noc.ws.nsrc.org librenms.ws.nsrc.org noc
